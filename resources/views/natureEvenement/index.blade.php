...
<meta name="csrf-token" content="{{ csrf_token() }}">
 ...
 <div x-data="miscellaneous">
    ...
    <!-- Texte -->
    <span class="font-semibold text-lg" style="color: #67152e;">LISTE DES NATURES EVENEMENTS</span>
</div>
...
<script>
    document.addEventListener("alpine:init", () => {
        Alpine.data("miscellaneous", () => ({
            ...
            showCols: [0, 1, 2, 3],
            datatable1: null,
            permissions: @json($natures), // Injecter les permissions depuis Laravel
            ...
            init() {
                ...
                // Générer les données pour chaque nature
                let data = this.permissions.map((natures) => [
                    natures.id,
                    natures.libelle,


                    formatDate(natures.created_at), // Formater la date
                    `
                        <ul class="flex items-center justify-center gap-2">
                            <!-- Icône pour éditer -->
                            <li>
                                <a href="/nature_evenements/${natures.id}/edit" x-tooltip="Edit">
                            ...
                            <li>
                                <form action="/nature_evenements/${natures.id}" method="POST" style="display:inline;" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette nature ?');">
