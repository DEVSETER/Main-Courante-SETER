...
<meta name="csrf-token" content="{{ csrf_token() }}">
 ...
 <div x-data="miscellaneous">
    ...
    <!-- Texte -->
    <span class="font-semibold text-lg" style="color: #67152e;">LISTE IMPACTS</span>
</div>
            ...
            <a href="/impacts/create">Ajouter un Type d'impact</a>
        </button>
        @endcan
        </div>
        <div class="panel">
...
<script>
    document.addEventListener("alpine:init", () => {
        Alpine.data("miscellaneous", () => ({
            ...
            showCols: [0, 1, 2, 3],
            datatable1: null,
            permissions: @json($impacts), // Injecter les permissions depuis Laravel
            ...
            init() {
                ...
                // Générer les données pour chaque impact
                let data = this.permissions.map((impacts) => [
                    impacts.id,
                    impacts.libelle,
                    formatDate(impacts.created_at), // Formater la date
                    `
                        <ul class="flex items-center justify-center gap-2">
                            <!-- Icône pour éditer -->
                            <li>
                                <a href="/impacts/${impacts.id}/edit" x-tooltip="Edit">
                            ...
                            <li>
                                <form action="/impacts/${impacts.id}" method="POST" style="display:inline;" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce lieu ?');">
