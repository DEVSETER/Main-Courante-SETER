            ...
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/dashboard" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/assets/images/logo.png"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">SETER</span>
                </a>
                <a href="javascript:;"
...
{{-- <li class="nav-item">
                            <a href="#" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Gestion des Localisations</span>
                                </div>
                            </a>
                        </li> --}}
                        {{-- <li class="nav-item">
   ...
   <li class="menu nav-item">
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'users'" x-collapse class="sub-menu text-gray-500">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="/users/user-account-settings">Privilèges </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'authentication'" x-collapse
                        ...
                        <li>
                            <a href="/auth/boxed-signup" target="_blank">Ajouter Utilisateur</a>
                        </li>
                        <li>
