...
{{-- <pre>{{ json_encode($roles, JSON_PRETTY_PRINT) }}</pre> --}}
    ...
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path opacity="0.5"
              ...
              stroke="currentColor" stroke-width="1.5" />
                ...
                <!-- Texte -->
                <span class="font-semibold text-lg">LISTE DES RÔLES</span>
            </div>
            ...
            <button  class="btn btn-primary flex items-center">
                ...
                <a href="/auth/boxed-signup" target="_blank">Ajouter un role</a>
            </button>
        </div>
        <div class="panel">
            <h5 class="md:absolute md:top-[25px] md:mb-0 mb-5 font-semibold text-lg dark:text-white-light">RÔLES</h5>
            <div class="relative">
...
<script>
    ...
    Alpine.data("miscellaneous", () => ({
        ...
        showCols: [0, 1],
        datatable1: null,
        roles: @json($roles), // Injecter les rôles depuis Laravel
