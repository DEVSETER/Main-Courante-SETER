            ...
            <div class="flex gap-3">
                ...
                @can('Créer événement')
                    {{-- <button class="btn btn-primary ml-auto flex items-center"
                        ...
                        Ajouter un nouvel evenement CM
                    </button> --}}
                    <button class="btn btn-primary ml-auto flex items-center"
                    style="background-color: #67152e; border-color: #67152e; color: #fff;"
                    @click="resetParams(); addContactModal = true">
        ...
        <div x-show="addContactModal" x-transition x-transition.duration.300
            ...
            <button type="button"
                ...
                <h3 class="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]"
                    x-text="params && typeof params === 'object' && 'id' in params && params.id ? 'Mettre à jour l\'evenement' : 'Ajouter evenement CM'"></h3>
                <div class="p-5">
                    <form x-data="{ submitting: false }"
      @submit.prevent="if (!submitting) { submitting = true; saveEvent(); }"
                            ...
                            <div class="flex flex-col md:flex-row gap-8 items-stretch">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input type="hidden" name="post" value="CM">
                                    </div>
                                    <div class="mb-5">
