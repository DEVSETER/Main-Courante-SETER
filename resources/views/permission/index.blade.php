                ...
                let data = this.permissions.map((permission) => [
                    ...
                    `
                        <ul class="flex items-center justify-center gap-2">
                            <!-- Icône pour éditer -->
                            <li>
                                <a href="/permissions/${permission.id}/edit" x-tooltip="Edit">
                            ...
                            <li>
                                <form action="/permissions/${permission.id}" method="POST" style="display:inline;" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette permission ?');">
