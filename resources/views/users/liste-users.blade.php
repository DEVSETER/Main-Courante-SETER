 ...
 <div x-data="miscellaneous">
    <div class="space-y-6">
        <div class="panel flex items-center justify-between overflow-x-auto whitespace-nowrap p-3 text-primary">
            ...
            {{-- <span class="font-semibold text-lg ltr:ml-3 rtl:mr-3">LISTE DES UTILISATEURS</span> --}}
            {{-- <span class="ltr:mr-0 rtl:ml-3">LISTE DES UTILISATEURS</span> --}}
            {{-- <button type="button" class="btn btn-primary ml-auto flex items-center" @click="auth/boxed-signup">
                ...
                <a href="/auth/boxed-signup" target="_blank">Ajouter un utilisateur</a>
            </button> --}}
            <div class="flex items-center">
                ...
                <!-- Texte -->
                <span class="font-semibold text-lg">LISTE DES UTILISATEURS</span>
            </div>
