                                                        ...
                                                        (this.$d = (function (t, e, n) {
                                                            try {
                                                                ...
                                                                var D = o || 0,
                                                                    ...
                                                                    g = h || 0;
                                                                return c
                                                                    ? new Date(Date.UTC(M, m, $, D, v, p, g + 60 * c.offset * 1e3))
                                                                    : n
                ...
                function (require, module, exports) {
                    ...
                    class h {
                                    ...
                                    (i = e.cloneNode(!1)),
                                        ...
                                        t.forEach((t) => {
                                            (r = e.cells[t].cloneNode(!0)),
                                                ...
                                                i.appendChild(r),
                                                o.hiddenColumns.includes(t) || ((r = e.cells[t].cloneNode(!0)), (r.data = e.cells[t].data), a.appendChild(r));
                                        }),
                                        l[2].push(i),
                                        l[3].push(a);
                                }),
                        ...
                        add(t) {
                            ...
                            this.dt.hiddenHeader ? (s.innerHTML = '') : t.heading.nodeName ? s.appendChild(t.heading) : (s.innerHTML = t.heading),
                                ...
                                t.hasOwnProperty('sortable') &&
                                    ((s.sortable = t.sortable), s.setAttribute('data-sortable', !0 === t.sortable ? 'true' : 'false')),
                                this.rebuild(),
                        ...
                        filter(t, e, s, i) {
                            ...
                            (a.data = h),
                                a.data.length ? (this.rebuild(), a.update()) : (a.clear(), (a.hasRows = !1), a.setMessage(a.options.labels.noRows)),
                                ...
                                Array.from(h).forEach((e) => {
                                    ...
                                    (a = p ? p(i) : 'string' == typeof i ? i.replace(/(\$|,|\s|%)/g, '') : i),
                                        parseFloat(a) == a
                                            ...
                                            : (r[o++] = { value: 'string' == typeof i ? i.toLowerCase() : i, row: e });
                                }),
                                    e || (e = c.classList.contains('asc') ? 'desc' : 'asc'),
                                    'desc' == e
                                        ? ((u = a(r, -1)), (g = a(l, -1)), c.classList.remove('asc'), c.classList.add('desc'))
                                        : ((u = a(l, 1)), (g = a(r, 1)), c.classList.remove('desc'), c.classList.add('asc')),
                    ...
                    class o {
                        ...
                        render(t) {
                            ...
                            if (
                                ...
                                s.footer
                                    ? this.head && !this.foot && ((this.foot = e('tfoot', { html: this.head.innerHTML })), this.dom.appendChild(this.foot))
                        ...
                        renderPage() {
                            if (
                                (this.hasHeadings && (s(this.header), this.activeHeadings.forEach((t) => this.header.appendChild(t))),
                                    ...
                                    this.options.columns.forEach((t) => {
                                        Array.isArray(t.select) || (t.select = [t.select]),
                                            t.hasOwnProperty('render') &&
                                                ...
                                                this.columnRenderers.push({ columns: t.select, renderer: t.render })),
                                            t.select.forEach((e) => {
                        ...
                        paginate() {
                            ...
                            return (
                                ...
                                this.options.paging
                                    ? (this.pages = e.map((s, i) => (i % t == 0 ? e.slice(i, i + t) : null)).filter((t) => t))
                                    : (this.pages = [e]),
                                ...
                                t.length
                                    ? (this.clear(),
                                      ...
                                      this.searchData.length
                                          ? this.update()
                                          : (this.wrapper.classList.remove('search-results'), this.setMessage(this.options.labels.noResults)),
                        ...
                        page(t) {
                            return (
                                ...
                                !(t > this.pages.length || t < 0) && (this.render('page'), this.render('pager'), void this.emit('datatable.page', t)))
                            );
                        }
                        sortColumn(t, e) {
