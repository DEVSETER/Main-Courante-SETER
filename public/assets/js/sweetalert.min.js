!(function (e, t) {
        ...
        J = (e) => {
            ...
            for (const n in e)
                (t = n),
                    ...
                    e.toast && ((t = n), K.includes(t) && a('The parameter "'.concat(t, '" is incompatible with toasts'))),
                    (t = n),
                    Z(t) && N(t, Z(t));
            var t;
        };
    ...
    const s = { previousBodyPadding: null },
            ...
            if (!t.toast) {
                ...
                if (/^ru\b/.test(navigator.language) && location.host.match(/\.(ru|su|xn--p1ai)$/)) {
                    ...
                    (n.className = p['no-war']),
                        y(n, '<a href="https://www.youtube.com/watch?v='.concat(t.youtubeId, '" target="_blank">').concat(t.text, '</a>')),
                        e.appendChild(n),
        ...
        Me = (e, t) => {
            var n,
                ...
                s = ne(),
                c = d();
            (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? P : B)(s),
                v(s, t, 'actions'),
                (s = s),
                (n = c),
                (o = t),
                ...
                o.reverseButtons &&
                    (o.toast ? (s.insertBefore(r, i), s.insertBefore(a, i)) : (s.insertBefore(r, n), s.insertBefore(a, n), s.insertBefore(i, n))),
                y(c, t.loaderHtml),
                v(c, t, 'loader');
        };
    ...
    const He = (e, t) => {
        ...
        i &&
            ...
            (o = i),
            (n = t.position) in p ? w(o, p[n]) : (a('The "position" parameter is not valid, defaulting to "center"'), w(o, p.center)),
            (n = i),
    ...
    const De = ['input', 'file', 'range', 'select', 'radio', 'checkbox', 'textarea'],
        ...
        Fe = (e, t) => {
            ['string', 'number'].includes(typeof t)
                ? (e.value = ''.concat(t))
                : F(t) || a('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t, '"'));
        },
        L = {},
        We =
            ((L.text = L.email = L.password = L.number = L.tel = L.url = (e, t) => (Fe(e, t.inputValue), Re(e, e, t), Ne(e, t), (e.type = t.input), e)),
                    ...
                    setTimeout(() => {
                        if ('MutationObserver' in window) {
                            ...
                            new MutationObserver(() => {
                                var e =
                                    n.offsetWidth +
                                    ((e = n), parseInt(window.getComputedStyle(e).marginLeft) + parseInt(window.getComputedStyle(e).marginRight));
        ...
        _e = (e, t) => {
            ...
            if (t.icon || t.iconHtml) {
                if (t.icon && -1 === Object.keys(o).indexOf(t.icon))
                    return l('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')), void B(n);
        ...
        ot = (e, t) => {
            var n = m();
            const o = g();
            t.toast ? (A(n, 'width', t.width), (o.style.width = '100%'), o.insertBefore(d(), X())) : A(o, 'width', t.width),
                A(o, 'padding', t.padding),
                t.color && (o.style.color = t.color),
                t.background && (o.style.background = t.background),
                B(te());
            n = o;
            ((n.className = ''.concat(p.popup, ' ').concat(x(n) ? t.showClass.popup : '')), t.toast)
    ...
    class bt {
        ...
        stop() {
            return (
                this.running && ((this.running = !1), clearTimeout(this.id), (this.remaining -= new Date().getTime() - this.started.getTime())), this.remaining
            );
        }
    ...
    const yt = () => {
            null === s.previousBodyPadding &&
                ...
                ((s.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue('padding-right'))),
        ...
        Ct = (e) => {
            ...
            return (
                ...
                (n === o || !(be(o) || 'INPUT' === n.tagName || 'TEXTAREA' === n.tagName || (be(Q()) && Q().contains(n))))
            );
        },
        kt = () => {
            var e;
            c(document.body, p.iosfix) &&
                ((e = parseInt(document.body.style.top, 10)), C(document.body, p.iosfix), (document.body.style.top = ''), (document.body.scrollTop = -1 * e));
        },
        At = 10,
        Pt = (e) => {
            const t = g();
                ...
                'object' != typeof n[0] || cn(n[0])
                    ? ['title', 'html', 'icon'].forEach((e, t) => {
                          ...
                          'string' == typeof t || cn(t)
                              ? (o[e] = t)
                              : void 0 !== t && l('Unexpected type of '.concat(e, '! Expected "string" or "Element", got ').concat(typeof t));
                      })
                    : Object.assign(o, n[0]),
                o
            );
    ...
    const hn = (l, u, d) =>
            new Promise((e, t) => {
                ...
                It.swalPromiseResolve.set(l, e),
                    ...
                    (t = u),
                    (a = n),
                    S.innerParams.get(e).toast ? tn(e, t, a) : (on(t), an(t), rn(e, t, a)),
                    (o = l),
                    (e = E),
                    (t = d),
                    (i = n),
                    ...
                    'select' === (t = d).input || 'radio' === t.input
                        ? Tt(a, t)
                        : ['text', 'email', 'number', 'tel', 'textarea'].includes(t.input) && (U(t.inputValue) || F(t.inputValue)) && (M(h()), St(a, t));
                {
                    var r = d;
                    const s = m(),
                        c = g();
                    'function' == typeof r.willOpen && r.willOpen(c),
                        ...
                        ce() || E.previousActiveElement || (E.previousActiveElement = document.activeElement),
